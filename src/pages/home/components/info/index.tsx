...
const Info: React.FC<InfoProps> = ({ mb }) => {
	...
	const TabPanel: React.FC = () => {
		const infos = [
			...
			'This platforn offers a variety of games for every gaming style, from classic RPGs to thrilling adventures. Our games have unique gameplay, frequent updates, and a user-friendly interface for easy game selection and socializing. Join our versatile hub for 2D MMO game enthusiasts.',
		];
